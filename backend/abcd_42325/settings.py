"""
Django settings for abcd_42325 project.
...
WSGI_APPLICATION = 'abcd_42325.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "abcd_42325 API",
    "DESCRIPTION": "API documentation for abcd_42325 App",
    "VERSION": "v1",
}
